...
pub use kernels::{
    ...
    call_delta_chunk_step_windowed, call_delta_chunk_step_windowed_2d, call_delta_full_scan,
    call_delta_recurrent_prefill, call_delta_state_scan, call_delta_state_update,
    call_full_attention_prefill, call_linear_prefill_conv_pack, call_mlx_gemm, cast::*,
